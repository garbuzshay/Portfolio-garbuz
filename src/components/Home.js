...
const Home = () => {
  return (
    <section id="home" className="bg-gradient-to-r from-blue-400 to-blue-600 dark:from-gray-700 dark:to-gray-900 text-white min-h-screen flex flex-col items-center justify-center">
